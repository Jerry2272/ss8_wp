<?php
/**
 * ss8 functions and definitions.
 */

if ( ! function_exists( 'ss8_setup' ) ) {
	/**
	 ...
	 */
		function ss8_setup() {
			...
			* to change 'ss8' to the name of your theme in all the template files.
			*/
			load_theme_textdomain( 'ss8', get_template_directory() . '/languages' );
			...
			*/
			...
			register_nav_menus(
				array(
					'primary'        => esc_html__( 'Primary', 'ss8' ),
					'explore'         => esc_html__( 'Explore Menu', 'ss8' ),
					'contact'         => esc_html__( 'Contact Menu', 'ss8' ),
					'socials'         => esc_html__( 'Socials Menu', 'ss8' ),
					'header_action'  => esc_html__( 'Header Action', 'ss8' ),
					'invest'  => esc_html__( 'Invest Industry', 'ss8' ),
				)
			);
...
add_action( 'after_setup_theme', 'ss8_setup' );
 ...
 */
function ss8_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'ss8_content_width', 1170 );
}
add_action( 'after_setup_theme', 'ss8_content_width', 0 );
 ...
 * @since 1.0.0
 */
function ss8_sidebar_widgets_init() {
	// Default Sidebar
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'ss8' ),
			'id'            => 'default-sidebar',
			'description'   => esc_html__( 'Add widgets here.', 'ss8' ),
...
add_action( 'widgets_init', 'ss8_sidebar_widgets_init' );

/**
 * Enqueue public scripts and styles.
 */
function ss8_public_scripts() {
	// Styles.
...
add_action( 'wp_enqueue_scripts', 'ss8_public_scripts' );

/**
 * Enqueue admin scripts and styles.
 */
// function ss8_admin_scripts() {
// 	// Admin styles.
// 	wp_enqueue_style( 'admin-style', get_template_directory_uri() . '/assets/css/admin-style.css', array(), wp_rand(), 'all' );
// }
// add_action( 'admin_enqueue_scripts', 'ss8_admin_scripts' );
